...
class Matchmaking(Thread):
    def __init__(self, config: dict, api: API, variant: Variant):
    ...
    def _challenge_opponent(self, opponent: dict, color: Challenge_Color):
        ...
        print(f'challenging {opponent} as {color.value} color')
    ...
    def _set_timeout(self, bot: dict, success: bool, game_duration: timedelta):
        self._save()
